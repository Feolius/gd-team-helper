...
class AuthStore extends singleton {
    ...
    constructor() {
        ...
        gapi.load('client', {
            callback: () => {
                gapi.client.setToken({access_token: 'ya29.Gl1JB8hAUDmEypUfnQhMXPk0lGgweKkvKU9Y3Zd_thRCmcH4vn2Y5G1CK6IIL12NhT6Q2JuE8eOKQm7gHlq79NfURU_1YPeqjj2y7toE4iOD9aaTxsYdMSB6Tv8XnEE'});
